...
export default function (revealElement, options) {
	...
	function initialize(initOptions) {
		...
		var listCountslide = getTotalSlides(); //slidecount 
		var sus_val = "";
		var sus_cnt = 0;
		var sus_comp = '';
		var sus_value = 0;
		...
		console.log("Sus_val2 at start" + sus_val2);
		// sus_val2 = "00000000000000000000000000000000000000000000000";
		var sumresul = 0;

		if (sus_datafrmdb == "") {
			for (i = 1; i <= listCountslide; i++) {
				sus_val += "0";
			}
			sus_cnt = 0;
		} else {
	...
	function navigatePrev() {
		...
		sus_val2 = '{"lang":"en","a11y":false,"sus_cnt":"' + sus_cnt + '","completion":"' + finalstring + '","questions":"","_isCourseComplete":false,"_isAssessmentPassed":false}';
	...
	function navigateNext() {
		...
		if (sus_value.length <= (listCountslide + 1)) {
			...
			if (finalstring.length == (listCountslide + (listCountslide - 1))) { //values should not go more than 55
				...
				sus_cnt++;
				// $('#'+sus_cnt +">a").css('color','#218f8b');
				sus_val2 = '{"lang":"en","a11y":false,"sus_cnt":"' + sus_cnt + '","completion":"' + finalstring + '","questions":"","_isCourseComplete":false,"_isAssessmentPassed":false}';
				api.LMSSetValue("cmi.suspend_data", sus_val2);
				console.log("sus_cnt " + sus_cnt);
			}
		}
